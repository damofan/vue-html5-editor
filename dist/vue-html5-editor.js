...
(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global.VueHtml5Editor = factory());
}(this, (function() {
    'use strict';
                    ...
                    !function(n) {
                        ...
                        function u() {
                            ...
                            for (var e = 0, t = this._deferreds.length; t > e; e++) {
                                o.call(this$1, this$1._deferreds[e]);
                            }
 ...
 */
    var buildInModules = [text, color, font, align, list, link, unlink, table, image, hr, eraser, undo, fullScreen$1, info];
        ...
        case Command.FONT_SIZE:
            {
                ...
                if (textNodes.length === 1 && textNodes[0] === this.range.startContainer && textNodes[0] === this.range.endContainer) {
                    ...
                    span$1.innerText = textNode.textContent.substring(this.range.startOffset, this.range.endOffset);
                ...
                textNodes.forEach(function(textNode) {
                    if (textNode === this$1.range.startContainer) {
                        ...
                        textNode.textContent = textNode.textContent.substring(0, this$1.range.startOffset);
        ...
        case Command.INSERT_IMAGE:
            {
                var fragment = document.createDocumentFragment();
                var div = document.createElement('div');
                div.innerHTML = '<img src="'+arg+'" style="max-height:300px;" />';
                if (div.hasChildNodes()) {
                    for (var i = 0; i < div.childNodes.length; i++) {
                        fragment.appendChild(div.childNodes[i].cloneNode(true));
                    }
...
//////////////////
// WEBPACK FOOTER
// ./~/._vue-html5-editor@1.1.1@vue-html5-editor/dist/vue-html5-editor.js
// module id = 259
// module chunks = 0
